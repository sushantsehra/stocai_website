...
export default function NavbarStocai() {
  ...
  const handleResourcesNavigate = useCallback((path: string) => {
    setTimeout(() => {
  ...
  return (
    <nav className="flex justify-between items-center w-full">
      ...
      <ul className="hidden lg:flex items-center justify-start ml-8 mt-2">
        {navItems.map((item) => {
