...
export default function LoginPopup({ isOpen, onClose }: LoginPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-xl w-full max-h-[90vh] overflow-hidden animate-in fade-in-0 zoom-in-95 duration-300">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 p-2 bg-gray-100 rounded-full shadow-lg hover:bg-gray-200 transition-colors group focus:outline-none focus:ring-2 focus:ring-gray-300"
          aria-label="Close popup"
        >
