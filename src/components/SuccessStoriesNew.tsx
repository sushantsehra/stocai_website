      ...
      <div className="md:hidden p-1 bg-[#4D4D4D]">
        <div className="py-4 px-1">
          ...
          <div className="text-center text-[#F8F3F0]">
            <h2 className="text-[#F8F3F0] text-[24px] font-bold font-quattrocento mb-1">
              Success Stories
            </h2>
            <p className="font-medium font-jakarta text-[12px] text-[#F8F3F0]">
          ...
          <div className="flex gap-[10px] mt-[20px] overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide mx-2">
            {CARDS.map((card, index) => (
              <div
                key={index}
                className="bg-[#2C2C2C] rounded-[10px] overflow-hidden flex flex-col border border-[#4D4D4D] flex-shrink-0 snap-start"
                style={{ width: '42vw' }}
              >
                <div className="relative h-[105px]">
                  <Image
                    ...
                    priority={index === 0}
                  />
                  <div className="absolute top-[6px] right-[5px] bg-[#014BAA] text-white px-[6px] py-[2px] rounded-[6px] text-[5px] z-10 font-medium font-inter">
                    Promoted
                  </div>
                </div>
          ...
          <div className="text-center mt-5">
            ...
            >
              Request Access <span className="translate-y-[-3px]"><GoArrowRight size={15} className="inline" /></span>
            </button>
          </div>
        </div>
      </div>
...
//                     priority={index === 0}
//                   />
//                   <div className="absolute top-[6px] right-[6px] bg-[#014BAA] text-white px-[4px] py-[2px] rounded-[6px] text-[5px] z-10 font-medium font-inter">
//                     Promoted
//                   </div>
//                 </div>
//                 <div className="p-2 bg-[#181818] flex-grow">
//                   <p className="text-[#F8F3F0] font-medium font-inter text-[12px] mt-2 mb-[10px] leading-[15px] md:leading-[9px]">
//                     {card.text}
//                   </p>
