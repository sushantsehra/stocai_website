    ...
    <footer className="bg-slate-900 text-white py-8 md:py-12 px-4 sm:px-6">
      <div className="max-w-full mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
          <div>
            <h3 className="text-xl sm:text-2xl lg:text-[24px] font-bold mb-4">
              Be More <span className="text-[#2474F5]">Promotable</span>
            </h3>
            <p className="text-white/70 mb-6 text-xs sm:text-sm lg:text-base leading-5.5">
          ...
          <div>
            <h4 className="mb-4 text-sm sm:text-base font-bold">Quick Links</h4>
            <ul className="space-y-2 text-xs sm:text-sm  lg:text-base">
              {quickLinks.map((link: string, index: number) => (
                <li key={index}>
                  <a href="#" className="text-white/70 font-normal hover:text-white transition-colors">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-white/70 lg:text-base font-normal text-xs sm:text-sm mb-2">hello@bemorepromotable.com</p>
            <p className="text-white/70 lg:text-base font-normal text-xs sm:text-sm mb-6">Based in Bangalore, India</p>
            <div className="pt-4 border-t border-white/10">
              <p className="text-xs sm:text-sm md:text-[14px] font-normal text-white/50 mb-2">Secure Payments</p>
              <div className="flex flex-wrap items-center gap-3 text-xs md:text-[12px] text-white/50">
                ...
                <span className="flex items-center gap-1 text-white/50">
                  <FaLock className="w-3 h-3 text-white/50" />
                  256-bit Encryption
                </span>
              </div>
            </div>
        ...
        <div className="pt-6 md:pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs sm:text-sm md:text-[14px] text-white/50">
            <p>© 2026 BCL Career Labs. All rights reserved.</p>
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              {footerLinks.map((link: string, index: number) => (
                <a key={index} href="#" className="hover:text-white transition-colors md:text-[14px] text-white/50">
                  {link}
                </a>
              ))}
            </div>
